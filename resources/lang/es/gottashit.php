...
return [
    ...
    */
    ...
    'email' => [
        ...
        'new_place_action' => "Nuevo sitio creado por <a href=':user_path'>:username</a>",
        'new_comment_add' => "Añadieron un nuevo comentario a :place",
        'new_contact_form' => "Nuevo contacto desde el sitio web",
        'new_comment_call_to_action' => "Ver comentario",
        'new_place_call_to_action' => "Ver nuevo sitio",
        'confirm_email_call_to_action' => "Confirma tu correo electrónico",
        'thanks' => "Gracias",
    ],
    ...
    'user' => [
        ...
        'number_of_archived_places' => 'Cantidad de lugares archivados',
    ...
    'place' => [
        ...
        'archive_place' => 'Archivar Sitio',
        'archive_place_confirm' => '¿Está seguro?',
        ...
        'archived_place' => ':place Archivado',
