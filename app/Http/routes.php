...
Route::get('/auth/{provider}', ['as' => 'social_login', 'uses' => 'Auth\AuthController@redirectToProvider'])->where('provider', 'facebook|github|twitter');
Route::get('/auth/{provider}/callback', ['as' => 'social_callback', 'uses' => 'Auth\AuthController@handleProviderCallback'])->where('provider', 'facebook|github|twitter');