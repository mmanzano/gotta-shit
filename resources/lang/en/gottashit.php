...
return [
    ...
    */
    ...
    'email' => [
        ...
        'new_place_action' => "New place created by <a href=':path_user'>:username</a>",
        'new_comment_add' => 'New comment added for :place',
        'new_contact_form' => "New contact sended from web",
        'new_comment_call_to_action' => "View comment",
        'new_place_call_to_action' => "View new place",
    ...
    'user' => [
        ...
        'number_of_archived_places' => 'Number of archived places',
    ...
    'place' => [
        ...
        'archive_place_confirm' => 'Are you sure?',
